      ...
      <div className="flex flex-col justify-center h-screen w-[90%] m-auto text-center">
        <div className="flex flex-col relative justify-center h-[100%] rounded-md shadow-md md:p-10 lg:p-20 ">
          <div className="grid grid-cols-1 md:grid-cols-2 mx-2 ">
            <header className="md:flex flex-col justify-start pt-12">
              ...
              <p className="font-light text-base text-white pt-10 md:text-left px-5">
          ...
          Form creation */}
            ...
            <div className="icons-container inline-flex flex-col mt-10 mb-20">
              <form className="form text-start px-4 py-14 rounded-lg p-4 flex flex-col">
                <label
                  htmlFor="name"
                ...
                <button
                  ...
                  className="bg-[#49ff49] text-black rounded-md w-1/2 mx-4 mt-8 py-2 text-xs font-bold shadow-none"
                >
                  Send Message
                </button>
              </form>
